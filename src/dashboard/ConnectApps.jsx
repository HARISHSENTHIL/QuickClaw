          ...
          {telegramExpanded && !saved && (
            <div className="app-card-form">
              <p className="app-form-hint">
                Create a bot via <button className="inline-link" onClick={() => window.electronAPI?.openUrl('https://t.me/BotFather')}>@BotFather</button> on Telegram, then paste the token below.
              </p>
